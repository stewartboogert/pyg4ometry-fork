...
def Test(vis=False, interactive=False):
    ...
    d_physical1 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [d1_y, 0, d1_z], d_logical, "d_physical1", w_logical, reg
    )
    d_physical2 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [d2_y, 0, d2_z], d_logical, "d_physical2", w_logical, reg
    )
    d_physical3 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [d3_y, 0, d3_z], d_logical, "d_physical3", w_logical, reg
    )

    d_physical4 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [-d1_y, 0, d1_z], d_logical, "d_physical4", w_logical, reg
    )
    d_physical5 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [-d2_y, 0, d2_z], d_logical, "d_physical5", w_logical, reg
    )
    d_physical6 = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [-d3_y, 0, d3_z], d_logical, "d_physical6", w_logical, reg
    )

    bp_physical = _pyg.geant4.PhysicalVolume(
        [0, 0, 0], [0, 0, -660], bp_logical, "bp_physical", w_logical, reg
    )
