...
PYBIND11_MODULE(Nef_polyhedron_3, m) {
  py::class_<Nef_polyhedron_3_EPECK>(m, "Nef_polyhedron_3_EPECK")
      ...
      .def("number_of_halffacets",
           &Nef_polyhedron_3_EPECK::number_of_halffacets)
      ...
      .def("volume_begin",
           [](Nef_polyhedron_3_EPECK &np) { return np.volumes_begin(); })
      .def("volume_end",
           [](Nef_polyhedron_3_EPECK &np) { return np.volumes_end(); })
      /* Operations */
      .def("convert_to_polyhedron",
           [](Nef_polyhedron_3_EPECK &np, Polyhedron_3_EPECK &p) {
             np.convert_to_polyhedron(p);
           })
      .def("convert_inner_shell_to_polyhedron",
           [](Nef_polyhedron_3_EPECK &np,
              Nef_polyhedron_3_EPECK_Shell_entry_iterator &si,
              Polyhedron_3_EPECK &p) {
             np.convert_inner_shell_to_polyhedron(si, p);
           });

  py::class_<Nef_polyhedron_3_EPECK_Volume_iterator>(
      m, "Nef_polyhedron_3_EPECK_Volume_iterator")
      .def(py::init<>())
      .def(
          "next", [](Nef_polyhedron_3_EPECK_Volume_iterator &i) { ++i; },
          py::return_value_policy::reference)
      .def("__ne__",
           [](Nef_polyhedron_3_EPECK_Volume_iterator i1,
              Nef_polyhedron_3_EPECK_Volume_iterator i2) { return i1 != i2; })
      .def("mark",
           [](Nef_polyhedron_3_EPECK_Volume_iterator &i) { return i->mark(); })
      .def("shells_begin",
           [](Nef_polyhedron_3_EPECK_Volume_iterator &i) {
             return i->shells_begin();
           })
      .def("shells_end", [](Nef_polyhedron_3_EPECK_Volume_iterator &i) {
        return i->shells_end();
      });

  py::class_<Nef_polyhedron_3_EPECK_Shell_entry_iterator>(
      m, "Nef_polyhedron_3_EPECK_Shell_entry_iterator")
      .def(py::init<>())
      .def(
          "next", [](Nef_polyhedron_3_EPECK_Shell_entry_iterator &i) { ++i; },
          py::return_value_policy::reference)
      .def("__ne__", [](Nef_polyhedron_3_EPECK_Shell_entry_iterator i1,
                        Nef_polyhedron_3_EPECK_Shell_entry_iterator i2) {
        return i1 != i2;
      });
  ...
  py::class_<Nef_polyhedron_3_EPICK>(m, "Nef_polyhedron_3_EPICK")
      ...
      .def("number_of_halffacets",
           &Nef_polyhedron_3_EPICK::number_of_halffacets)
      ...
      .def("volume_begin",
           [](Nef_polyhedron_3_EPICK &np) { return np.volumes_begin(); })
      .def("volume_end",
           [](Nef_polyhedron_3_EPICK &np) { return np.volumes_end(); })
      /* Operations */
      .def("convert_to_polyhedron",
           [](Nef_polyhedron_3_EPICK &np, Polyhedron_3_EPICK &p) {
             np.convert_to_polyhedron(p);
           });

  py::class_<Nef_polyhedron_3_EPICK_Volume_iterator>(
      m, "Nef_polyhedron_3_EPICK_Volume_iterator")
      .def(py::init<>())
      .def(
          "next", [](Nef_polyhedron_3_EPICK_Volume_iterator &i) { ++i; },
          py::return_value_policy::reference)
      .def("__ne__",
           [](Nef_polyhedron_3_EPICK_Volume_iterator i1,
              Nef_polyhedron_3_EPICK_Volume_iterator i2) { return i1 != i2; })
      .def("mark",
           [](Nef_polyhedron_3_EPICK_Volume_iterator &i) { return i->mark(); })
      .def("shells_begin",
           [](Nef_polyhedron_3_EPICK_Volume_iterator &i) {
             return i->shells_begin();
           })
      .def("shells_end", [](Nef_polyhedron_3_EPICK_Volume_iterator &i) {
        return i->shells_end();
      });

  py::class_<Nef_polyhedron_3_EPICK_Shell_entry_iterator>(
      m, "Nef_polyhedron_3_EPICK_Shell_entry_iterator")
      .def(py::init<>())
      .def(
          "next", [](Nef_polyhedron_3_EPICK_Shell_entry_iterator &i) { ++i; },
          py::return_value_policy::reference)
      .def("__ne__", [](Nef_polyhedron_3_EPICK_Shell_entry_iterator i1,
