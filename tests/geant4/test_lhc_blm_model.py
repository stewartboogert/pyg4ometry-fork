...
def circle_points(r, cx=0, cy=0, sa=0.0, ea=2 * _np.pi, npoints=30):
    points = []
...
def electrode_profile():
    ...
    ele_cut_pos = 63 / 2.0  # Radial position of cut centre
...
def lhc_blm(vis=False, interactive=False, n_slice=16, outputPath=None):
    ...
    ae = _g4.ElementSimple("aluminium", "Al", 13, 27.0)
    ...
    gas_pv = _g4.PhysicalVolume([0, 0, 0], [0, 0, 0], gas_lv, "gas_pv1", world_lv, reg)
    ...
    active_gas_solid = _g4.solid.Tubs(
        "active_gas_volume",
        zero,
        active_gas_r,
        active_gas_len,
    ...
    endcap_s_pv = _g4.PhysicalVolume(
        [0, 0, 0], endcap_s_pos, endcap_s_lv, "endcap_s_pv1", gas_lv, reg
    )
    ...
    endcap_e_pv = _g4.PhysicalVolume(
        [0, 0, 0], endcap_e_pos, endcap_e_lv, "endcap_e_pv1", gas_lv, reg
    )
    ...
    for i, angle in enumerate(ins_cut_angles):
        ...
        interim_solid = _g4.solid.Subtraction(
            name, interim_solid, insulator_cut, cut_tra, reg, "mm"
        )
    ...
    insulator_pv2 = _g4.PhysicalVolume(
        [0, 0, 0], insulator_pos2, insulator_lv, "insulator_pv2", gas_lv, reg
    )
    ...
    electrode_solid = _g4.solid.Tubs(
        "electrode_base",
        zero,
        ele_rad,
        electrode_l - safety_def,
        zero,
        twopi,
        reg,
        "mm",
    ...
    for i, angle in enumerate(ele_cut_angles):
        ...
        electrode_solid = _g4.solid.Subtraction(
            name, electrode_solid, electrode_cut, cut_tra, reg, "mm"
        )
    ##########################################################################################
    ...
    sp_a_notch = _g4.solid.Box(
        "spacer_a_notch", spacer_notch_w, spacer_notch_h, spacer_a_notch_l, reg, "mm"
    )

    sp_a_notch1_tra = [[0, 0, 0], [0, 0, spacer_a_l / 2.0 - spacer_a_notch_l / 2.0]]
    sp_a_int = _g4.solid.Subtraction(
    ...
    support_rod_solid = _g4.solid.Tubs(
        "support_rod",
        zero,
        rod_r - safety,
        rod_l - safety,
    ...
    support_rod_lv = _g4.LogicalVolume(
        support_rod_solid, support_rod_material, "support_rod_lv", reg
    )
    ...
    for i in range(31):
        for j in range(3):
            ...
            support_rod_pv = _g4.PhysicalVolume(
                [0, 0, 0],
                spacer_pos,
                support_rod_lv,
        ...
        electrode_pv = _g4.PhysicalVolume(
            [0, 0, 0],
            electrode_pos,
            electrode_lv,
            f"electrode_pv_1_{i}",
